...
import ComponentAReducer from '../CuseReducer/ComponentA'

import ComponentA_C from '../ContextC/ComponentA'
...
function Nreact() {
	...
	const [state, dispatch] = useReducer(reducerContext, initialStateReducer)
		...
		<>
			<section className="section">
				<div className="container">
					...
					<div class="is-flex is-justify-content-center is-align-items-center notification mt-2">
					...
					<div className="is-flex is-justify-content-center is-align-items-center">
						...
						<div style={{ margin: '2em', textAlign: 'center' }}>
							<h1>Learn useContextUseReducer</h1>
							<UseContextUseReducer.Provider value={{ state, dispatch }}>
								<ComponentAReducer />
							</UseContextUseReducer.Provider>
						</div>
						<div style={{ margin: '2em', textAlign: 'center' }}>
							<h1>Learn ContextComponent</h1>
							<CountProvider>
								<ComponentA_C />
							</CountProvider>
						</div>
...
export const UseContextUseReducer = React.createContext()
